...
echo ========================================
echo ProcessVFS Plugin Build Script v1.0
echo ========================================
echo.
...
set OUTFILE=%OUTDIR%\ProcessVFS.dll

if defined RESFILE (
    cl.exe %CXXFLAGS% %INCLUDES% %DEFINES% %SOURCES% /Fe"%OUTFILE%" /link /DEF:src/ProcessVFS.def %LIBS% %RESFILE%
) else (
    cl.exe %CXXFLAGS% %INCLUDES% %DEFINES% %SOURCES% /Fe"%OUTFILE%" /link /DEF:src/ProcessVFS.def %LIBS%
)
