...
cl.exe /MT /O2 /EHsc /std:c++17 /utf-8 /I "." /I "include" /LD src\ProcessVFS.cpp resource.res /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DDOPUS_PLUGIN_HELPER /DVFSPLUGINVERSION=2 /link /DEF:src\ProcessVFS.def Advapi32.lib Shell32.lib Comctl32.lib Psapi.lib User32.lib /OUT:"%OUTDIR%\ProcessVFS.dll"
